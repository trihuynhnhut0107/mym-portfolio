...
export function Layout12Slots({
  ...
  return (
    <div className="w-full flex flex-col gap-0">
      ...
      {/* ROW 2: Horizontal Image 16:9 (flex-[16]) + Square 1:1 (flex-[9]) */}
      <div className="flex flex-col md:flex-row w-full gap-0 items-stretch">
        <div className="w-full md:w-auto md:flex-[16]">
          {getSlot(4, "Image", "16:9", "1920x1080", "aspect-[16/9]")}
        </div>
        <div className="w-full md:w-auto md:flex-[9]">
          {getSlot(5, "Logo", "1:1", "1000x1000", "aspect-square")}
        </div>
      </div>

      {/* ROW 3: Full Width Feature Video 1920x1080 */}
      <div className="w-full">
        {getSlot(6, "Video", "16:9", "1920x1080", "aspect-[16/9]")}
      </div>

      {/* ROW 4: 2x Image 1920x1080 (Row of 2) */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-0">
        {getSlot(7, "Image", "16:9", "1920x1080", "aspect-[16/9]")}
