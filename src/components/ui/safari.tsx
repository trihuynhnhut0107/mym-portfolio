...
export function Safari({
  ...
  const hasImage = !hasVideo && !!imageSrc
  const hasCustomContent = !!children
  const hasMedia = hasVideo || hasImage || hasCustomContent
  ...
  return (
    <div
      ...
      {...props}
    >
      {/* Interactive / Custom Children (e.g. Live iframe) */}
      {hasCustomContent && (
        <div
      ...
      >
        ...
        >
          ...
          <path
            ...
            className="fill-[#E5E5E5] dark:fill-[#1A1A1A]"
          />
