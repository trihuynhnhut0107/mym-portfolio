...
export const PROJECTS_DETAIL_DATA: Record<string, ProjectDetail> = {
  ...
  "cup-hoc-xem-bong": {
    ...
    media: [video("https://drive.google.com/file/d/1Xz1Kz5ppNhRzYzztR2baJzjDHVlXlFLB/preview"), ...numbered("cup-hoc-xem-bong", ["2.png", "3.png", "4.png", "5.png", "6.png"]), video("https://drive.google.com/file/d/1DbZF75YQNZgmHSjpwKP7MOI_Rx3nUo7K/preview", "portrait"), video("https://drive.google.com/file/d/1TQDqofOdKf6DpSWdXQUdRs3fvkJXnXhv/preview", "portrait"), ...numbered("cup-hoc-xem-bong", ["9.png", "10.png", "11.png", "12.png", "13.png", "14.png", "15.png", "16.png"]), embed("https://www.youtube.com/watch?v=ep_oOmFukpY"), ...numbered("cup-hoc-xem-bong", ["18.png", "19.png", "20.png", "21.png", "22.png", "23.png"])],
  },
